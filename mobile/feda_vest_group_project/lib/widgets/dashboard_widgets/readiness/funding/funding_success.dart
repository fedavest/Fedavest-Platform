...
class FundingSuccess extends StatefulWidget {
  const FundingSuccess({super.key});

  @override
  State<FundingSuccess> createState() => _FundingSuccessState();
}

class _FundingSuccessState extends State<FundingSuccess> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppText(text: "Your Funding Goal is set", textSize: 12),
