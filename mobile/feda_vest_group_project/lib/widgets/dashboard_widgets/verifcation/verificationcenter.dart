      ...
      body: Column(
        children: [
          AppHeader(
            ...
            subtitle: "Complete all steps to unlock full access",
          ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: const [
                        BenefitItem(
                          text: "3x more profile views from investors",
                        ),
                        BenefitItem(
                          text: "Access to premium funding opportunities",
                        ),
                        BenefitItem(
                          text: "Higher credibility score and trust badges",
                        ),
                        BenefitItem(
                          text: "Priority support from FedaVest team",
                        ),
                      ],
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(18),
        border: isVerified
            ? Border(left: BorderSide(color: AppColors.primaryColor, width: 4))
            : Border.all(color: Color(0xFFD4AF37), width: 1.2),
      ),
...
class BenefitItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(Icons.check_circle, color: Color(0xFF0F3D2E), size: 20),
          SizedBox(width: 8),
          Expanded(
